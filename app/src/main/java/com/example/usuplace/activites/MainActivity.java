...
public class MainActivity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        ItemArraylist.add(new ItemDomain("Casa de campo1", "Usulután, Usulután", "Es el mejor lugar para vacacionar", 12, "pic1"));
        ItemArraylist.add(new ItemDomain("Casa de campo2", "Santa María, Usulután", "Es el mejor lugar para vacacionar", 12, "pic2"));
        ItemArraylist.add(new ItemDomain("Casa de campo3", "Tecapán, Usulután", "Es el mejor lugar para vacacionar", 12, "pic1"));
        ItemArraylist.add(new ItemDomain("Casa de campo4", "Alegría, Usulután", "Es el mejor lugar para vacacionar", 12, "pic2"));
